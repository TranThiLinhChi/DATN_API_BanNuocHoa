...
namespace API.Controllers
{
    ...
    public class SanPhamController : ControllerBase
    {
        ...
        public SanPhamController(ISanPhamBLL productBusiness, IConfiguration configuration)
        {
        ...
        [HttpGet]
        public IEnumerable<SanPham> GetProductRelated(int masp, string maloai)
        {
            return _productBusiness.GetProductRelated(masp, maloai);
        }
        [Route("get-by-id/{id}")]
        [HttpGet]
        ...
        [Route("get-data")]
        [HttpGet]
        public IEnumerable<SanPham> GetData()
        {
            return _productBusiness.GetData();
        }
        [Route("get-new")]
        [HttpGet]
        ...
        [Route("get-status")]
        [HttpGet]
        public IEnumerable<SanPham> GetDataStatus()
        {
            return _productBusiness.GetDataStatus();
        }
        ...
        [HttpGet]
        public IEnumerable<SanPham> SearchName(string searchName)
        {
            return _productBusiness.SearchName(searchName);
        }
        [Route("get-product-related/{id}/{category_id}")]
        [HttpGet]
        public IEnumerable<SanPham> Getproductrelated(int id, string maloai)
        {
            return _productBusiness.GetProductRelated(id,maloai);
        }
        [Route("search-home")]
        [HttpPost]
        public ResponseModel SearchHome([FromBody] Dictionary<string, object> formData)
        {
            ...
            try
            {
                ...
                var pageSize = int.Parse(formData["pageSize"].ToString());
                string keyword = "";
                if (formData.Keys.Contains("keyword") && !string.IsNullOrEmpty(Convert.ToString(formData["keyword"])))
                {
                    keyword = Convert.ToString(formData["keyword"]);
                    long total = 0;
